...
public class NewsArticleRepository {
    ...
    public MutableLiveData<List<NewsArticle>> getMostViewedNYTimePopularArticles(final BaseViewModel viewModel, Call<List<NewsArticle>> listCall, int newsArticlePeriod) {
        ...
        if (networkUtils.isConnectedToInternet()) {
            ...
            listCall = apiService.getMostViewedNYTimePopularArticles("all-sections", newsArticlePeriod, BuildConfig.API_KEY);
